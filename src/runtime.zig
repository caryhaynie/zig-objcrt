...
pub fn object_getInstanceVariable(comptime ValueType: type, obj: id, name: [*c]const u8) Error!struct { ivar: Ivar, value: ValueType } {
...
pub fn getClass(class_name: [*c]const u8) Error!Class {
...
pub fn getMetaClass(class_name: [*c]const u8) Error!Class {
...
pub fn lookUpClass(class_name: [*c]const u8) ?Class {
...
pub fn class_getClassVariable(class: Class, name: [*c]const u8) Error!Ivar {
...
pub fn class_addMethod(class: Class, selector: SEL, imp: IMP, types: [*c]const u8) bool {
    return (c.class_addMethod(class, selector, @ptrCast(*const fn () callconv(.C) void, imp), types) != 0);
}
...
pub fn class_replaceMethod(class: Class, selector: SEL, imp: IMP, types: [*c]const u8) ?IMP {
...
pub fn class_addIvar(class: Class, name: [:0]const u8, size: usize, alignment: u8, types: [*c]const u8) bool {
...
pub fn allocateClassPair(superclass: ?Class, class_name: [*c]const u8, extra_bytes: usize) Error!Class {
...
pub fn getProtocol(name: [*c]const u8) Error!*Protocol {
